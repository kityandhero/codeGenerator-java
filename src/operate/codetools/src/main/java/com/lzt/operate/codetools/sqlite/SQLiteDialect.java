...
public class SQLiteDialect extends Dialect {
    ...
    public IdentityColumnSupport getIdentityColumnSupport() {
        return SQLiteDialect.IDENTITY_COLUMN_SUPPORT;
    }

    @Override
    public LimitHandler getLimitHandler() {
        return SQLiteDialect.LIMIT_HANDLER;
    }
    ...
    public SQLExceptionConversionDelegate buildSQLExceptionConversionDelegate() {
        return new SQLExceptionConversionDelegate() {
            ...
            public JDBCException convert(SQLException sqlException, String message, String sql) {
                ...
                if (errorCode == SQLiteDialect.SQLITE_TOOBIG || errorCode == SQLiteDialect.SQLITE_MISMATCH) {
                    return new DataException(message, sqlException, sql);
                } else if (errorCode == SQLiteDialect.SQLITE_BUSY || errorCode == SQLiteDialect.SQLITE_LOCKED) {
                    return new LockAcquisitionException(message, sqlException, sql);
                } else if ((errorCode >= SQLiteDialect.SQLITE_IOERR && errorCode <= SQLiteDialect.SQLITE_PROTOCOL) || errorCode == SQLiteDialect.SQLITE_NOTADB) {
    ...
    public ViolatedConstraintNameExtracter getViolatedConstraintNameExtracter() {
        return SQLiteDialect.EXTRACTER;
    }
