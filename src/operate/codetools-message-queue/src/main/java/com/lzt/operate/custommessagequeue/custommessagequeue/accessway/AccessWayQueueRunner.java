 ...
 * @author luzhitao
 */
public class AccessWayQueueRunner<T extends BaseConsumerAdapter<AccessWay, ConcurrentLinkedDeque<AccessWay>>> implements Runnable {

	private AccessWayService accessWayService;

	private T consumer;

	public AccessWayQueueRunner(AccessWayService accessWayService, T consumer) {
